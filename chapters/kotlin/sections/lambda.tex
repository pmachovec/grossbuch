...
Then, inside the~lambda function body, the~call \mbitqls{return@LABEL\_NAME;;;RETURN\_VALUE}, or~\mbitq{return@LABEL\_NAME} without any~return value (returning \hyperref[kotlinunit]{Unit}), must~be made.
