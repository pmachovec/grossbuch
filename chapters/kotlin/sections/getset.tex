...
When~you \hyperref[declarationdefinition]{declare} the~property with the~\mbitq{val} keyword, the~setter isn't~created.
...
Kotlin enables adding more logic \mbox{by \itq{get}} \mbox{and \itq{set}} keywords written under the~affected property \hyperref[declarationdefinition]{declaration} and~followed by~a~function body.
In~these function bodies the~keyword \mbitq{field} is available to~access the~current value of~the~corresponding \hyperref[variablefieldproperty]{field} variable.
