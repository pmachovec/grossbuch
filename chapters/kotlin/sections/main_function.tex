...
\newsubsection{As~a~\hyperref[kotlinstandalone]{standalone function}}
This is the~real Kotlin approach -- define the~function in~a~Kotlin file outside any class.
A~class with \mbox{the \itq{-Kt}} suffix is~generated during compilation and~it~contains the~desired static method.

%! language = TEXT
\begin{lstlisting}[language=Kotlin, title={A~standalone main function in a~file \textit{Example.kt}}]
    fun main(args: Array<String>) {
        ...SOME CODE...
    }
\end{lstlisting}
