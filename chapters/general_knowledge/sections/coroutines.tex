...
\index{Coroutine}
\index{Coprogram}
\mbox{A \textit{coroutine}}, or~also \mbox{a \textit{coprogram},} is~a~sequence of~tasks, which can~be run asynchronously (the~whole sequence, individual tasks must~be executed one after another).
