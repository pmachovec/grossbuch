...
\warning Don't get confused by the~term \textit{attribute}. That's either a~different name for~\hyperref[variablefieldproperty]{object field} or~a~\hyperref[relationaldatabase]{relational database} table column.
