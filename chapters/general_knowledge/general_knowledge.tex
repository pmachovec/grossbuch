...
\begin{itemize}
    ...
    \itembf{Character encoding}, also called \itq{encoding scheme} or~simply \itq{encoding}, is~a~way how code points (numbers) from a~character set are~stored in~\hyperref[bitsandbytes]{bytes}.
