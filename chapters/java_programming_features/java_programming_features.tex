...
An~instance of~such class can~be assigned to~a~variable of~the~abstract class type.
...
When you need some common behavior for~descendants, it's~better to~implement some common \hyperref[dependencyinjection]{dependency} or~\hyperref[javastatic]{static} method.
...
A~general rule is that members of~an~abstract class must~be either abstract (must~be \hyperref[javaoverride]{overridden} in~descendants), or~final (can't~be \hyperref[javaoverride]{overridden} in~descendants).
...
\begin{lstlisting}[language=Java, title={Abstract class}]
    public abstract class (*\tmnbf{abstract1class1}{AbstractClass}*) {
        public abstract void (*\tmnbf{abstract1method1}{abstractMethod}*)((*\tmnbf{abstract1param1}{Object abstractMethodParam}*));
...
\begin{lstlisting}[language=Java, title={Concrete class}]
    public class (*\tmnbf{abstract1concreteclass1}{ConcreteClass}*) extends (*\tmnbf{abstract1class2}{AbstractClass}*) {
        @>@Override
        public void (*\tmnbf{abstract1method2}{abstractMethod}*)((*\tmnbf{abstract1param2}{Object abstractMethodParam}*)) {
            ...
        }
    }
\end{lstlisting}
\begin{lstlisting}[language=Java, title={Usage\,--\,concrete class instance in~the~variable of~the~abstract class type}]
    ...
    abstractClassVariable.(*\tmnbf{abstract1method3}{abstractMethod}*)(...SOME_OBJECT...);
...
\begin{tikzpicture}[remember picture, overlay]
    ...
    \drawarrow{abstract1class1.south}{abstract1class3.north}
    \drawarrow{abstract1method1.south}{[xshift=-3mm] abstract1method2.north}[red]
    \drawarrow{[xshift=-3mm] abstract1method2.south}{abstract1method3.north}[red]
    \drawarrow{abstract1param1}{abstract1param2}[green]
    \drawarrow{[xshift=-3mm] abstract1concretemethod1.south}{[xshift=3mm] abstract1concretemethod2.north}[blue]
    \drawarrow{[xshift=-3mm] abstract1concreteclass1.south east}{abstract1concreteclass2.north}[Magenta]
\end{tikzpicture}
