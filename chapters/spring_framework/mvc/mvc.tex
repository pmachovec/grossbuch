...
\begin{itemize}
    \itembf{Model} is~represented by~an~instance of~the~class \textit{Model} from the~package \itq{org.springframework.ui}.
            Any~object can~be inserted to~the~model instance as~an~attribute (\itq{model.addAttribute(OBJECT,"attributeName")}).
