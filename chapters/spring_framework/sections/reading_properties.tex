...
\note Using the~\mboxtextit{.properties} extension is only a~convention for~key--value files. The~name can~be anything, the~important thing is the~format \mboxtextitquoted{key\,=\,value}.
\newpage
