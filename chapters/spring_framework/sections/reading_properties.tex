...
\label{properties}
Files with the~\mboxtextitquoted{.properties} extension are~popular approach for~dynamic applications configuration.
...
\note Using the~\mboxtextitquoted{.properties} extension is only a~convention for~key--value files.
...
\begin{lstlisting}[title={A \textit{properties} file called \tikzmarknodebf{readprop1prop1filename}{\textit{constructor.properties}}}]
...
\begin{lstlisting}[language=XML, title={Configuration XML}]
    ...
    <beans ...
      ...
      <bean id="someBeanId" class="(*\tikzmarknodebf{readprop1xml1package}{somepackage.subpackage}[ForestGreen]*).(*\tikzmarknodebf{readprop1xml1class}{WantedClass}[ForestGreen]*)">
        <constructor-arg value="(*\SSS*){(*\tikzmarknodebf{readprop1xml1intvalue}{intvalue}[ForestGreen]*)}"/>
        <constructor-arg value="(*\SSS*){(*\tikzmarknodebf{readprop1xml1floatvalue}{floatvalue}[ForestGreen]*)}"/>
        <constructor-arg value="(*\SSS*){(*\tikzmarknodebf{readprop1xml1stringvalue}{stringvalue}[ForestGreen]*)}"/>
      </bean>
    </beans>
\end{lstlisting}
...
\begin{lstlisting}[title={A \textit{properties} file called \tikzmarknodebf{readprop2prop1filename}{\textit{setters.properties}}}]
...
\begin{lstlisting}[language=XML, title={Configuration XML}]
    ...
    <beans ...
      ...
      <bean id="someBeanId" class="(*\tikzmarknodebf{readprop2xml1package}{somepackage.subpackage}[ForestGreen]*).(*\tikzmarknodebf{readprop2xml1class}{WantedClass}[ForestGreen]*)">
        <property name="(*\tikzmarknodebf{readprop2xml1intvaluefield}{intValueField}[ForestGreen]*)" value="(*\SSS*){(*\tikzmarknodebf{readprop2xml1intvalue}{intvalue}[ForestGreen]*)}"/>
        <property name="(*\tikzmarknodebf{readprop2xml1floatvaluefield}{floatValueField}[ForestGreen]*)" value="(*\SSS*){(*\tikzmarknodebf{readprop2xml1floatvalue}{floatvalue}[ForestGreen]*)}"/>
        <property name="(*\tikzmarknodebf{readprop2xml1stringvaluefield}{stringValueField}[ForestGreen]*)" value="(*\SSS*){(*\tikzmarknodebf{readprop2xml1stringvalue}{stringvalue}[ForestGreen]*)}"/>
      </bean>
    </beans>
\end{lstlisting}
...
\thispagestyle{empty}
\example
\begin{lstlisting}[title={A \textit{properties} file called \tikzmarknodebf{readprop3prop1filename}{\textit{annotations.properties}}}]
...
\begin{lstlisting}[language=Java, title={Wanted class with any constructor}]
    ...
    public class WantedClass implements WantedClassInterface {
        @@>@Value<@@("(*\SSS*){(*\tikzmarknodebf{readprop3java1intvalue}{intvalue}[ForestGreen]*)}")
        private int intValueField;

        @@>@Value<@@("(*\SSS*){(*\tikzmarknodebf{readprop3java1floatvalue}{floatvalue}[ForestGreen]*)}")
        private float floatValueField;

        @@>@Value<@@("(*\SSS*){(*\tikzmarknodebf{readprop3java1stringvalue}{stringvalue}[ForestGreen]*)}")
        private String stringValueField;
...
It~takes the~\textit{properties} file name with the~\mboxtextitquoted{classpath:} prefix as~a~parameter.
...
\begin{lstlisting}[title={A \textit{properties} file called \tikzmarknodebf{readprop4prop1filename}{\textit{annotations.properties}}}]
...
\begin{lstlisting}[language=Java, title={Wanted class with any constructor}]
    ...
    public class WantedClass implements WantedClassInterface {
        @@>@Value<@@("(*\SSS*){(*\tikzmarknodebf{readprop4java2intvalue}{intvalue}[ForestGreen]*)}")
        private int intValueField;

        @@>@Value<@@("(*\SSS*){(*\tikzmarknodebf{readprop4java2floatvalue}{floatvalue}[ForestGreen]*)}")
        private float floatValueField;

        @@>@Value<@@("(*\SSS*){(*\tikzmarknodebf{readprop4java2stringvalue}{stringvalue}[ForestGreen]*)}")
        private String stringValueField;
...
\begin{lstlisting}[title={A \textit{properties} file called \tikzmarknodebf{readprop5prop1filename}{\textit{annotations.properties}}}]
...
\begin{lstlisting}[language=Java, title={Wanted class with any constructor}]
    ...
    public class (*\tikzmarknodebf{readprop5java2class}{WantedClass}*) implements WantedClassInterface {
        @@>@Value<@@("(*\SSS*){(*\tikzmarknodebf{readprop5java2intvalue}{intvalue}[ForestGreen]*)}")
        private int intValueField;

        @@>@Value<@@("(*\SSS*){(*\tikzmarknodebf{readprop5java2floatvalue}{floatvalue}[ForestGreen]*)}")
        private float floatValueField;

        @@>@Value<@@("(*\SSS*){(*\tikzmarknodebf{readprop5java2stringvalue}{stringvalue}[ForestGreen]*)}")
        private String stringValueField;
