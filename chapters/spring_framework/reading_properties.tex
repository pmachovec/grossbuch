...
\begin{lstlisting}[language=XML, title={Configuration XML}]
    ...
    <beans ...
           ...
           ...>
      <(*\textcolor{blue}{context:}*)property-placeholder location="classpath:(*\tikzmarknodebf{readprop1xml1filename}{constructor.properties}[ForestGreen]*)"/>
...
\begin{lstlisting}[language=XML, title={Configuration XML}]
    ...
    <beans ...
           xmlns:context="http://www.springframework.org/schema/context"
           ...>
      <(*\textcolor{blue}{context:}*)property-placeholder location="classpath:(*\tikzmarknodebf{readprop2xml1filename}{setter.properties}[ForestGreen]*)"/>
...
\newline\warning When combined with annotations of~the~\hyperref[iocannotations]{inversion of~control} or~the~\hyperref[autowiring]{dependency injection}, the~\textit{property--placeholder} element must go after the~\textit{component--scan} element.
...
\begin{lstlisting}[language=XML, title={Configuration XML}]
    ...
    <beans ...
      ...
      <(*\textcolor{blue}{context:}*)property-placeholder location="classpath:(*\tikzmarknodebf{readprop3xml1filename}{annotations.properties}[ForestGreen]*)"/>
    </beans>
\end{lstlisting}
