...
\begin{lstlisting}[language=XML, title={Configuration XML}]
    ...
    <beans ...>
      <bean id="(*\tikzmarknodebf{di1xml1depbeanid}{dependencyBeanId}[ForestGreen]*)" class="somepackage.subpackage.DependencyClass"/>
      <bean id="(*\tikzmarknodebf{di1xml1beanid}{wantedBeanId}[ForestGreen]*)" class="somepackage.subpackage.(*\tikzmarknodebf{di1xml1class}{WantedClass}[ForestGreen]*)">
...
\begin{lstlisting}[language=XML, title={Configuration XML}]
    <?xml version="1.0" encoding="UTF-8"?>
    <beans ...>
      <bean id="(*\tikzmarknodebf{di2xml1depbeanid}{dependencyBeanId}[ForestGreen]*)" class="somepackage.subpackage.DependencyClass"/>
      <bean id="(*\tikzmarknodebf{di2xml1beanid}{wantedBeanId}[ForestGreen]*)" class="somepackage.subpackage.(*\tikzmarknodebf{di2xml1class}{WantedClass}[ForestGreen]*)">
...
\begin{lstlisting}[language=XML, title={Configuration XML}]
    <?xml version="1.0" encoding="UTF-8"?>
    <beans ...>
      <bean id="(*\tikzmarknodebf{di9xml1beanid}{wantedBeanId}[ForestGreen]*)" class="somepackage.subpackage.(*\tikzmarknodebf{di9xml1class}{WantedClass}[ForestGreen]*)">
...
\begin{lstlisting}[language=XML, title={Configuration XML}]
    <?xml version="1.0" encoding="UTF-8"?>
    <beans ...>
      <bean id="(*\tikzmarknodebf{di10xml1beanid}{wantedBeanId}[ForestGreen]*)" class="somepackage.subpackage.(*\tikzmarknodebf{di10xml1class}{WantedClass}[ForestGreen]*)">
