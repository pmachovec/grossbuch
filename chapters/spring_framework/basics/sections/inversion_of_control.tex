...
\begin{tikzpicture}[remember picture, overlay]
    \drawarrow{ioc1xml1beanid.south}{ioc1java2beanid.north}[black][.3][bend right=12mm]
    \drawarrow{ioc1xml1package.south}{[xshift=3mm]ioc1java1package.north}[red]
    \drawarrow{ioc1xml1class.south}{[xshift=-3mm] ioc1java1class.north east}[green]
    \drawarrow{ioc1java1interface.south}{ioc1java2interface.north}[blue]
    \drawarrow{ioc1java1interface.south}{ioc1java2interface2.north}[blue]
\end{tikzpicture}
...
You~can even specify more XML configuration files (or~even none at~all), the~constructor \mbit{ClassPathXmlApplicationContext} accepts any~number of~(string) parameters (even zero).
...
\begin{tikzpicture}[remember picture, overlay]
    ...
    \drawarrow{ioc2xml1class.south}{ioc2java1class.north}[green]
    \drawarrow{ioc2xml1class.south}{ioc2java2class.north}[green]
    \drawarrow{ioc2xml1class.south}{ioc2java2class2.north}[green]
\end{tikzpicture}
...
This is done by~the~element \mbit{component-scan}, attribute \mbit{base-package}, from the~\hyperref[namespace]{namespace} \mbitq{\href{http://www.springframework.org/schema/context}{http://www.springframework.org/schema/context}}.
...
\begin{tikzpicture}[remember picture, overlay]
    ...
    \drawarrow{ioc3java1interface.south}{ioc3java2interface.north}[green]
    \drawarrow{ioc3java1interface.south}{ioc3java2interface2.north}[green]
\end{tikzpicture}
...
However, if~the~second letter of~the~bean class name is~in~uppercase (e.g.,~something like \textit{\mbox{RESTService}}), the~first letter of~the~bean~ID is~not changed to~lowercase (it~remains \mbit{RESTService}).
\newpage
...
\begin{tikzpicture}[remember picture, overlay]
    ...
    \drawarrow{ioc4java1interface.south}{ioc4java2interface.north}[green]
    \drawarrow{ioc4java1interface.south}{ioc4java2interface2.north}[green]
\end{tikzpicture}
...
The~\textit{Configuration} annotation doesn't allow multiple occurrence -- its declaration in~Spring implementation isn't annotated with the~\mbit{@Repeatable} annotation.
\newpage
...
\end{lstlisting}
\begin{tikzpicture}[remember picture, overlay]
    \drawarrow{[xshift=-6mm] ioc5java1package.south}{ioc5java2package.north}
    ...
    \drawarrow{ioc5java2interface.south}{ioc5java3interface.north}[blue]
    \drawarrow{ioc5java2interface.south}{ioc5java3interface2.north}[blue]
\end{tikzpicture}
...
\begin{tikzpicture}[remember picture, overlay]
    ...
    \drawarrow{ioc6java1interface.south}{ioc6java2interface.north}[red]
    \drawarrow{ioc6java1interface.south}{ioc6java3interface.north}[red]
    ...
    \drawarrow{[xshift=-7mm] ioc6java1class.south}{ioc6java2class.north}[blue]
\end{tikzpicture}
\newpage

\example[Java code configuration -- bean ID referenced from the creating method]
%! language = TEXT
\begin{lstlisting}[language=Java, title={Configuration class}]
    package confpackage.confsubpackage;
...
The~\textit{Bean} annotation doesn't allow multiple occurrence -- its declaration in~Spring implementation isn't annotated with the~\mbit{@Repeatable} annotation.
