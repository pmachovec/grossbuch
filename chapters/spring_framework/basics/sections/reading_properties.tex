...
\begin{lstlisting}[language=XML, title={Configuration XML}]
    ...
    <beans ...
      ...
      <bean id="someBeanId" class="(*\tikzmarknodebf{readprop1xml1package}{somepackage.subpackage}[ForestGreen]*).(*\tikzmarknodebf{readprop1xml1class}{WantedClass}[ForestGreen]*)">
        <constructor-arg value="(*\Sc*){(*\tikzmarknodebf{readprop1xml1intvalue}{intvalue}[ForestGreen]*)}"/>
        <constructor-arg value="(*\Sc*){(*\tikzmarknodebf{readprop1xml1floatvalue}{floatvalue}[ForestGreen]*)}"/>
        <constructor-arg value="(*\Sc*){(*\tikzmarknodebf{readprop1xml1stringvalue}{stringvalue}[ForestGreen]*)}"/>
      </bean>
    </beans>
\end{lstlisting}
...
\begin{lstlisting}[language=XML, title={Configuration XML}]
    ...
    <beans ...
      ...
      <bean id="someBeanId" class="(*\tikzmarknodebf{readprop2xml1package}{somepackage.subpackage}[ForestGreen]*).(*\tikzmarknodebf{readprop2xml1class}{WantedClass}[ForestGreen]*)">
        <property name="(*\tikzmarknodebf{readprop2xml1intvaluefield}{intValueField}[ForestGreen]*)" value="(*\Sc*){(*\tikzmarknodebf{readprop2xml1intvalue}{intvalue}[ForestGreen]*)}"/>
        <property name="(*\tikzmarknodebf{readprop2xml1floatvaluefield}{floatValueField}[ForestGreen]*)" value="(*\Sc*){(*\tikzmarknodebf{readprop2xml1floatvalue}{floatvalue}[ForestGreen]*)}"/>
        <property name="(*\tikzmarknodebf{readprop2xml1stringvaluefield}{stringValueField}[ForestGreen]*)" value="(*\Sc*){(*\tikzmarknodebf{readprop2xml1stringvalue}{stringvalue}[ForestGreen]*)}"/>
      </bean>
    </beans>
\end{lstlisting}
...
\begin{lstlisting}[language=Java, title={Wanted class with any constructor}]
    ...
    public class WantedClass implements WantedClassInterface {
        @@>@Value<@@("(*\Sc*){(*\tikzmarknodebf{readprop3java1intvalue}{intvalue}[ForestGreen]*)}")
        private int intValueField;

        @@>@Value<@@("(*\Sc*){(*\tikzmarknodebf{readprop3java1floatvalue}{floatvalue}[ForestGreen]*)}")
        private float floatValueField;

        @@>@Value<@@("(*\Sc*){(*\tikzmarknodebf{readprop3java1stringvalue}{stringvalue}[ForestGreen]*)}")
        private String stringValueField;
...
\begin{lstlisting}[language=Java, title={Wanted class with any constructor}]
    ...
    public class WantedClass implements WantedClassInterface {
        @@>@Value<@@("(*\Sc*){(*\tikzmarknodebf{readprop4java2intvalue}{intvalue}[ForestGreen]*)}")
        private int intValueField;

        @@>@Value<@@("(*\Sc*){(*\tikzmarknodebf{readprop4java2floatvalue}{floatvalue}[ForestGreen]*)}")
        private float floatValueField;

        @@>@Value<@@("(*\Sc*){(*\tikzmarknodebf{readprop4java2stringvalue}{stringvalue}[ForestGreen]*)}")
        private String stringValueField;
...
\begin{lstlisting}[language=Java, title={Wanted class with any constructor}]
    ...
    public class (*\tikzmarknodebf{readprop5java2class}{WantedClass}*) implements WantedClassInterface {
        @@>@Value<@@("(*\Sc*){(*\tikzmarknodebf{readprop5java2intvalue}{intvalue}[ForestGreen]*)}")
        private int intValueField;

        @@>@Value<@@("(*\Sc*){(*\tikzmarknodebf{readprop5java2floatvalue}{floatvalue}[ForestGreen]*)}")
        private float floatValueField;

        @@>@Value<@@("(*\Sc*){(*\tikzmarknodebf{readprop5java2stringvalue}{stringvalue}[ForestGreen]*)}")
        private String stringValueField;
