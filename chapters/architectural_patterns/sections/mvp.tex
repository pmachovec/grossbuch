...
\index{MVP}
Another pattern for~systems with user interface, used mainly in~desktop and~mobile applications.
...
\begin{itemize}
    ...
    \itembfd{View} multi--subcomponent layer displaying information to~a~user and~also receiving commands from~the~user and~delegating them to~the~presenter layer, for~example, a~set of~screens of~a~mobile applications.
