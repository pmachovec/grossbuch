...
\index{MVB}
\label{mvvm}
Known also as \mbitq{Model--View--Binder} (MVB), it's another pattern for~systems with user interface, used mainly in~desktop and~mobile \hyperref[applicationprocessprogramservicethread]{applications}.
...
\begin{itemize}
    ...
    \itembfd{View} information displayed to~a~user and~also functionality for~receiving commands from~the~user and~delegating them to~the~viewmodel, for~example, a~screen of~a~mobile \hyperref[applicationprocessprogramservicethread]{applications}.
