...
\begin{itemize}
    ...
    \itembfd{View} information displayed to~a~user, often in~a~form of~\hyperref[shellcligui]{GUI}, for~example, a~\hyperref[internetweb]{web page} with results of~a~\hyperref[webserviceapplication]{web service} computation.
