...
All~scripts written in~\hyperref[requirejs]{RequireJS}, \hyperref[nodejscommonjs]{CommonJS} or~any~other third-party library syntax still need their external libraries and~they don't use the~new native JavaScript modularity.
