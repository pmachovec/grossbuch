...
\begin{lstlisting}[language=JavaScript]
    define(['PATH_TO_OTHER_MODULE'], function((*\tikzmarknodebf{js1othmod1}{otherModuleHandler}*)) {
      let privateVariable = ...;
      let (*\tikzmarknodebf{js1modvar1}{publicVariable}*) = ...;

      function privateFunction() {
        ...
        (*\tikzmarknodebf{js1othmod2}{otherModuleHandler}*).publicFunctionFromOtherModule();
        ...
      }

      function (*\tikzmarknodebf{js1modfunc1}{publicFunction}*)() {
        ...
        privateFunction();
        ...
      }
      ...
      return {
        publicVariable: (*\tikzmarknodebf{js1modvar2}{publicVariable}*),
        publicFunction: (*\tikzmarknodebf{js1modfunc2}{publicFunction}*)
      }
    });
\end{lstlisting}
...
\begin{lstlisting}[language=JavaScript]
    define(function() {
      let privateVariable = ...;
      let (*\tikzmarknodebf{js2modvar1}{publicVariable}*) = ...;

      function privateFunction() {
        ...
      }

      function (*\tikzmarknodebf{js2modfunc1}{publicFunction}*)() {
        ...
        privateFunction();
        ...
      }
      ...
      return {
        publicVariable: (*\tikzmarknodebf{js2modvar2}{publicVariable}*),
        publicFunction: (*\tikzmarknodebf{js2modfunc2}{publicFunction}*)
      }
    });
\end{lstlisting}
\begin{tikzpicture}[remember picture, overlay]
...
\begin{lstlisting}[language=JavaScript,title={Main JavaScript file \textit{\tikzmarknodebf{js3mainscript}{main}.js}}]
    requirejs.config({
      paths: {
        ...
        (*\tikzmarknodebf{js3mainjquery1}{jquery}*): 'SOME_PATH/jquery-X.Y.Z.js'
        ...
      }
    });

    requirejs(['(*\tikzmarknodebf{js3mainjquery2}{jquery}[ForestGreen]*)', 'SOME_PATH/amd_module'],
    function((*\$*), amdModuleHandler) {
      (*\$*)('#(*\tikzmarknodebf{js3mainbutton}{buttonId}[ForestGreen]*)').click(function() {
        ...
...
\begin{lstlisting}[language=XML,title={Web page file loading the JavaScript file}]
    ...
    <html lang="en">
      <head>
        ...
        <script data-main="SOME_PATH/(*\tikzmarknodebf{js3htmlscript}{main}[ForestGreen]*)" src="SOME_OTHER_PATH/require.js"></script>
        ...
      </head>
      <body>
        ...
        <button id="(*\tikzmarknodebf{js3htmlbutton}{buttonId}[ForestGreen]*)">BUTTON_LABEL</button>
        ...
      </body>
    </html>
\end{lstlisting}
