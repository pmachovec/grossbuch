...
\label{shbash}
\begin{itemize}
    \itembf{SH}, also \textit{Bourne Shell}, is~a~very old \hyperref[scriptinglanguages]{scripting language} specification (not~one concrete language) following \hyperref[posix]{POSIX} \hyperref[protocolstandard]{standards}.
