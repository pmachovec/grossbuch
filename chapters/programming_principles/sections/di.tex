...
References to~dependencies are~stored in~fields.
And~setting concrete references to~these fields from outside is the~dependency injection.
I.e.,~when you instantiate a~class and~set an~instance of~another class to~a~field inside the~first class instance by~a~constructor or~by~a~setter, you~perform the~dependency injection.
