...
\NewDocumentCommand{\mbit}{m}{\mbox{\textit{#1}}}

\NewDocumentCommand{\mboxbreak}{m}{\mbox{#1}\allowbreak}

\NewDocumentCommand{\mbl}{>{\SplitList{;;}}m}{\ProcessList{#1}{\mboxbreak}}

\newif\iffirstitem
\firstitemtrue

\NewDocumentCommand{\spacembox}{m}{%
  \iffirstitem
    \mbl{#1}%
    \firstitemfalse
  \else
...
\NewDocumentCommand{\mbls}{>{\SplitList{;;;}}m}{\ProcessList{#1}{\spacembox}\firstitemtrue}

\NewDocumentCommand{\mbitq}{m}{\mbox{\itq{#1}}}

\NewDocumentCommand{\mbitqs}{m}{\mbox{\itqs{#1}}}

\NewDocumentCommand{\mbitl}{m}{\textit{\mbl{#1}}} % Separated by ;;, no spaces between words

\NewDocumentCommand{\mbitls}{m}{\textit{\mbls{#1}}} % Separated by ;; or ;;;, spaces between words on ;;;

\NewDocumentCommand{\mbitql}{m}{\itq{\mbl{#1}}}

\NewDocumentCommand{\mbitqsl}{m}{\itqs{\mbl{#1}}}

\NewDocumentCommand{\mbitqls}{m}{\mbitq{\mbls{#1}}}

\NewDocumentCommand{\mbitqsls}{m}{\mbitqs{\mbls{#1}}}
...
\NewDocumentCommand{\diagramarrow}{O{0mm} m m O{} O{}}{\draw[-{Stealth[length=7mm, width=4mm]}, line width=.3mm, shorten <=-#1] (#2) to node[#5] {#4} (#3);}
