...
\NewDocumentCommand{\mbitq}{m o}{\IfNoValueTF{#2}{\mbox{\itq{#1}}}{\mbox{\itq{#1}#2}}} % mbox textit quotes

\NewDocumentCommand{\mbitqsfront}{o m}{\IfNoValueTF{#1}{\mbox{\itqs{#2}}}{\mbox{#1 \itqs{#2}}}} % mbox textit quotes single front

\NewDocumentCommand{\mbitqs}{o m o}{\IfNoValueTF{#3}{\mbitqsfront[#1]{#2}}{\mbitqsfront[#1]{#2}#3}} % mbox textit quotes single
...
\NewDocumentCommand{\mbitqls}{m o}{\IfNoValueTF{#2}{"\textit{\mbls{#1}}"}{"\textit{\mbls{#1}}"#2}} % mbox textit quotes list spaces (space on ;;;)

\NewDocumentCommand{\mbitqsls}{m o}{\IfNoValueTF{#2}{\textquotesingle\textit{\mbls{#1}}\textquotesingle}{\textquotesingle\textit{\mbls{#1}}\textquotesingle#2}} % mbox textit quotes single list spaces (space on ;;;)
